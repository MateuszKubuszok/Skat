...
(deftest normal-game-value-test
  (let [t            true
    ...
    (testing "normal games should have positive values always"
      ...
      (is (== (* 24 6) (normal-game-value cards        :grand  f t f f)))
      ...
      (is (== (* 24 3) (normal-game-value cards-wout-1 :grand  f t f f)))
      ...
      (is (== (* 12 7) (normal-game-value cards        :kreuz  f t f f)))
      ...
      (is (== (* 12 3) (normal-game-value cards-wout-1 :kreuz  f t f f)))
      ...
      (is (== (* 11 7) (normal-game-value cards        :grun   f t f f)))
      ...
      (is (== (* 11 3) (normal-game-value cards-wout-1 :grun   f t f f)))
      ...
      (is (== (* 10 7) (normal-game-value cards        :herz   f t f f)))
      ...
      (is (== (* 10 3) (normal-game-value cards-wout-1 :herz   f t f f)))
      ...
      (is (== (*  9 7) (normal-game-value cards        :schell f t f f)))
      ...
      (is (== (*  9 3) (normal-game-value cards-wout-1 :schell f t f f)))
...
(deftest game-value-test
  (let [t            true
    ...
    (testing "all games should have positive values always"
      ...
      (is (== (* 24 6) (game-value cards        :grand  f t f f)))
      ...
      (is (== (* 24 3) (game-value cards-wout-1 :grand  f t f f)))
      ...
      (is (== (* 12 7) (game-value cards        :kreuz  f t f f)))
